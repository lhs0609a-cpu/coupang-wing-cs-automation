@echo off
chcp 65001 > nul
title Coupang Wing CS - Build Executable v2.1 (FIXED)

echo.
echo ======================================================================
echo   Coupang Wing CS - Executable Builder v2.1 (FIXED)
echo   Fixed: FastAPI middleware import errors
echo ======================================================================
echo.
...
echo ======================================================================
echo   Starting build process with FIXED version...
echo ======================================================================
echo.

REM Run FIXED build script
