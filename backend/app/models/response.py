...
class Response(Base):
    ...
    # Generation Details
    template_id = Column(Integer, ForeignKey("templates.id"), index=True)  # Template FK
    template_used = Column(String(100))  # Deprecated - kept for backward compatibility
    ...
    feedbacks = relationship("ResponseFeedback", back_populates="response")
